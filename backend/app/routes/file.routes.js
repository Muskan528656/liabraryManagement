...
module.exports = (app) => {
  ...
  //   "/clone",
  //   fetchUser,
  //   checkModuleAccess("campaign"),
  //   async (req, res) => {
  //     const { title, filetype, filesize, description, campaign_id } = req.body;
  //     const errors = [];
  //     if (!title) errors.push("title is required");
  //     if (!filetype) errors.push("filetype is required");
  //     if (!filesize) errors.push("filesize is required");
  //     if (!campaign_id) errors.push("campaign_id is required");
  ...
  //     try {
  //       const result = await fileModel.insertFileRecords(
  //         newFile,
  //         req.userinfo.id
  //       );
  //       if (result) {
  ...
  //         return res
  //           .status(400)
  //           .json({ success: false, errors: "File creation failed" });
  //       }
  //     } catch (error) {
