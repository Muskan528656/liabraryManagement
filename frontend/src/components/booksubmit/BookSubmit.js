...
//     // Purchase details fetch करें (book price के लिए)
...
//             const resp = await helper.fetchWithAuth(
//                 `${constants.API_BASE_URL}/api/purchase/book/${bookId}/latest`,
//                 "GET"
//             );
...
//     // Penalty calculation function - UPDATED
//     const calculatePenalty = async (issueRecord, condition = "Good") => {
//         if (!issueRecord) {
//             return {
//                 penalty: 0,
//                 daysOverdue: 0,
...
//         // Get book purchase details for price if condition is damaged or lost
//         let bookPrice = 0;
//         if (condition && (condition.toLowerCase() === "damaged" || condition.toLowerCase() === "lost")) {
//             const purchaseDetails = await fetchBookPurchaseDetails(issueRecord.book_id || book?.id);
//             if (purchaseDetails) {
//                 bookPrice = parseFloat(purchaseDetails.price) ||
//                     parseFloat(purchaseDetails.unit_price) ||
//                     parseFloat(purchaseDetails.total_price) || 0;
//             }
//         }
...
//         // 1. Late return penalty (per day basis)
...
//         // 2. Damaged book penalty (% of book price)
...
//         // 3. Lost book penalty (% of book price)
...
//     // When selectedIssue or conditionAfter changes, recalculate penalty
//     useEffect(() => {
//         if (selectedIssue) {
//             const recalculatePenalty = async () => {
//                 const calculatedPenalty = await calculatePenalty(selectedIssue, conditionAfter);
//                 setPenalty(calculatedPenalty);
//                 setPenaltyBreakdown(calculatedPenalty.breakdown);
//             };
//             recalculatePenalty();
//         }
//     }, [selectedIssue, conditionAfter]);

//     // Also recalculate when library settings change
//     useEffect(() => {
...
//             // Recalculate penalty with current condition
//             const finalPenalty = await calculatePenalty(selectedIssue, conditionAfter);
...
//             console.log("Submitting book data:", cleanedData);
//             console.log("Penalty amount to store:", cleanedData.penalty_amount);
...
//                             <Card>
//                                 <Card.Header className="py-2 d-flex justify-content-between align-items-center">
//                                     <h6 className="mb-0 small">Penalty Calculation</h6>
//                                     <div>
...
//                                     ) : penaltyBreakdown.length > 0 ? (
//                                         <div>
//                                             {/* Library Settings Info - UPDATED WITH BETTER COLORS */}
//                                             {librarySettings && (
//                                                 <div className="mb-3 p-2 border rounded" style={{
//                                                     background: "linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%)",
//                                                     borderLeft: "4px solid #3b82f6"
//                                                 }}>
//                                                     <h6 className="small fw-bold mb-2" style={{ color: "#1e40af" }}>
//                                                         <i className="fa-solid fa-gear me-1"></i>
//                                                         Library Settings
//                                                     </h6>
//                                                     <div className="row">
//                                                         <div className="col-6">
//                                                             <span className="small text-muted">Late Fee per Day:</span>
//                                                             <Badge bg="warning" className="ms-2" style={{ fontSize: "0.75em" }}>
//                                                                 ₹{librarySettings.fine_per_day || 0}/day
//                                                             </Badge>
//                                                         </div>
//                                                         <div className="col-6">
//                                                             <span className="small text-muted">Damage Penalty:</span>
//                                                             <Badge bg="danger" className="ms-2" style={{ fontSize: "0.75em" }}>
//                                                                 {librarySettings.damage_percentage || 50}% of book price
//                                                             </Badge>
//                                                         </div>
//                                                         <div className="col-6 mt-2">
//                                                             <span className="small text-muted">Lost Book Penalty:</span>
//                                                             <Badge bg="danger" className="ms-2" style={{ fontSize: "0.75em" }}>
//                                                                 {librarySettings.lost_percentage || 100}% of book price
//                                                             </Badge>
//                                                         </div>
//                                                     </div>
//                                                 </div>
...
//                                             {/* Book Purchase Price Info */}
//                                             {bookPurchaseDetails && (
//                                                 <div className="mb-3 p-2 border rounded" style={{
//                                                     background: "linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%)",
//                                                     borderLeft: "4px solid #10b981"
//                                                 }}>
//                                                     <h6 className="small fw-bold mb-2" style={{ color: "#065f46" }}>
//                                                         <i className="fa-solid fa-tag me-1"></i>
//                                                         Book Purchase Price
//                                                     </h6>
//                                                     <div className="row">
//                                                         <div className="col-6">
//                                                             <span className="small text-muted">Latest Price:</span>
//                                                             <span className="fw-bold text-success ms-2">
//                                                                 ₹{(bookPurchaseDetails.price || bookPurchaseDetails.unit_price || bookPurchaseDetails.total_price || 0).toFixed(2)}
//                                                             </span>
//                                                         </div>
//                                                         <div className="col-6">
//                                                             <span className="small text-muted">Purchase Date:</span>
//                                                             <span className="text-muted ms-2 small">
//                                                                 {formatDate(bookPurchaseDetails.purchase_date)}
//                                                             </span>
//                                                         </div>
//                                                     </div>
//                                                 </div>
...
//                                                 <div key={index} className="d-flex justify-content-between align-items-center mb-2 p-2 border rounded"
//                                                     style={{
//                                                         borderLeft: `4px solid ${item.color || "#6c757d"}`,
//                                                         background: item.isInfo ? "#f8f9fa" : "white"
//                                                     }}>
//                                                     <div>
//                                                         <div className="fw-bold small" style={{
//                                                             color: item.isInfo ? "#495057" : "#212529"
//                                                         }}>
//                                                             {item.type}
//                                                         </div>
//                                                         <div className="text-muted extra-small">{item.description}</div>
//                                                         <div className="text-primary extra-small">{item.calculation}</div>
//                                                     </div>
//                                                     <div className="fw-bold" style={{
//                                                         color: item.isInfo ? "#28a745" : (item.amount > 0 ? "#ef4444" : "#28a745")
//                                                     }}>
//                                                         {item.isInfo ? "" : "₹"}{item.amount.toFixed(2)}
//                                                     </div>
//                                                 </div>
//                                             ))}
...
//                                                 }}>
//                                                     <div className="d-flex justify-content-between">
//                                                         <span className="small fw-bold" style={{ color: "#92400e" }}>Days Overdue:</span>
//                                                         <span className="fw-bold" style={{ color: "#92400e" }}>{penalty.daysOverdue} day(s)</span>
//                                                     </div>
//                                                     <div className="d-flex justify-content-between mt-1">
//                                                         <span className="small fw-bold" style={{ color: "#92400e" }}>Fine per Day:</span>
//                                                         <span className="fw-bold" style={{ color: "#92400e" }}>₹{penalty.finePerDay || 0}/day</span>
//                                                     </div>
//                                                 </div>
//                                             )}
...
//                                                 borderLeft: `4px solid ${penalty.penalty > 0 ? "#ef4444" : "#10b981"}`
//                                             }}>
//                                                 <h4 style={{
...
//                                             borderLeft: "4px solid #10b981"
//                                         }}>
//                                             <h5 style={{ color: "#059669", fontWeight: "bold" }}>
//                                                 ₹{penalty.penalty?.toFixed(2) || "0.00"}
//                                             </h5>
//                                             <p className="small text-success mb-0">
//                                                 {penalty.daysOverdue ? `Overdue by ${penalty.daysOverdue} day(s)` : "No overdue penalty"}
//                                             </p>
//                                             {penalty.daysOverdue > 0 && penalty.finePerDay === 0 && (
//                                                 <div className="mt-2">
//                                                     <Badge bg="warning" className="me-1">
//                                                         <i className="fa-solid fa-info-circle me-1"></i>
//                                                         No late fee configured
//                                                     </Badge>
//                                                     <span className="small text-muted">Late penalty not configured in library settings</span>
//                                                 </div>
//                                             )}
//                                         </div>
//                                     )}
...
//                         variant="success"
//                         onClick={handleFinalSubmit}
//                         disabled={loading || isCalculating || isLoadingPurchaseDetails}
//                         style={{
//                             background: penalty.penalty > 0
...
const BookSubmit = () => {
    ...
    const [bookPurchaseDetails, setBookPurchaseDetails] = useState(null);
    const [isLoadingPurchaseDetails, setIsLoadingPurchaseDetails] = useState(false);
    const [lostBookPrice, setLostBookPrice] = useState(""); // नया state for lost book price input
    const [lostBookPriceError, setLostBookPriceError] = useState(""); // नया state for validation error
        ...
        try {
            ...
            if (resp.ok) {
                ...
                if (conditionAfter === "Lost" && purchaseDetails) {
                    const price = purchaseDetails.price || purchaseDetails.unit_price || purchaseDetails.total_price || 0;
    ...
    // Penalty calculation function - UPDATED with manual lost book price
    const calculatePenalty = async (issueRecord, condition = "Good", manualLostPrice = null) => {
        ...
        // For Lost condition, use manual input if available, otherwise fetch from purchase details
        if (condition && condition.toLowerCase() === "lost") {
        ...
        if (bookPrice > 0 && (condition.toLowerCase() === "damaged" || condition.toLowerCase() === "lost")) {
            breakdown.unshift({
                type: "Book Price",
                description: condition.toLowerCase() === "lost" ? "Lost book value (manually entered)" : "Latest purchase price",
    ...
    // Handle condition after change - specifically for Lost condition
    const handleConditionAfterChange = async (e) => {
        const newCondition = e.target.value;
        setConditionAfter(newCondition);

        // Reset lost book price when condition changes from Lost
        if (newCondition !== "Lost") {
            setLostBookPrice("");
            setLostBookPriceError("");
        } else {
            // If Lost is selected, fetch purchase details and set initial price
            if (selectedIssue) {
    ...
    // Handle lost book price input change
    const handleLostBookPriceChange = (e) => {
        ...
        if (value === "" || /^\d*\.?\d*$/.test(value)) {
            ...
            if (value !== "" && parseFloat(value) <= 0) {
                ...
                // Recalculate penalty when price changes
    ...
    // When modal opens, fetch purchase details for Lost condition
    useEffect(() => {
    ...
    const handleFinalSubmit = async () => {
        ...
        // Validate lost book price if condition is Lost
        ...
        try {
            ...
            // Recalculate penalty with current condition and manual price
            const manualPrice = conditionAfter === "Lost" ? lostBookPrice : null;
                        ...
                        <div>
                            ...
                            <Card className="mb-3">
                                ...
                                <Card.Body className="py-2">
                                    ...
                                    {/* Lost Book Price Field - Only shown when condition is Lost */}
                                    {conditionAfter === "Lost" && (
                                        <Form.Group className="mb-2">
                                            <Form.Label className="small fw-bold">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="ms-2">
                                                    <Button
                                                        ...
                                                        disabled={loading || isLoadingPurchaseDetails}
                                                        title="Fetch latest purchase price"
                                                    >
                                ...
                                <Card.Body className="py-2">
                                    {isCalculating || isLoadingPurchaseDetails ? (
                                        ...
                                        <div>
                                            ...
                                            {/* Book Purchase Price Info - Only for Lost condition */}
                                            {conditionAfter === "Lost" && lostBookPrice && (
                                                <div className="mb-3 p-2 border rounded" style={{
                                                    background: "linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%)",
                                                    borderLeft: "4px solid #10b981"
                                                }}>
                                                    <h6 className="small fw-bold mb-2" style={{ color: "#065f46" }}>
                                                        <i className="fa-solid fa-tag me-1"></i>
                                                        Book Value for Lost Calculation
                                                    </h6>
                                                    <div className="row">
                                                        <div className="col-6">
                                                            <span className="small text-muted">Entered Price:</span>
                                                            <span className="fw-bold text-success ms-2">
                                                                ₹{parseFloat(lostBookPrice || 0).toFixed(2)}
                                                            </span>
                                                        </div>
                                                        <div className="col-6">
                                                            <span className="small text-muted">Penalty Percentage:</span>
                                                            <span className="fw-bold text-danger ms-2">
                                                                {librarySettings?.lost_percentage || 100}%
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
