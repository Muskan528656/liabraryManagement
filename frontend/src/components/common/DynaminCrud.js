...
// //     console.log("importModel in DynamicCRUD:", importModel);
...
// //     const handleRemoveMultiRow = useCallback(
// //         (index) => {
...
// //     const handleLookupNavigation = useCallback(
// //         (lookupConfig, record, event = null) => {
// //             if (event) {
...
// //     const renderLookupLink = useCallback(
// //         (value, record, lookupConfig) => {
...
// //                         ...col,
// //                         render: (value, record) =>
// //                             renderLookupLink(value, record, lookupConfig),
// //                     };
// //                 }
...
// //                     (col.field === "title" ||
// //                         col.field === "name" ||
// //                         col.field === "card_number" ||
// //                         col.field === "role_name" ||
// //                         col.field === "purchase_serial_no" ||
// //                         col.field === "firstname" ||
// //                         col.field === "plan_name" ||
// //                         col.field === "module_name") &&
// //                     showDetailView &&
// //                     !col.render
// //                 ) {
// //                     return {
...
// //     }, [
// //         columns,
// //         customHandlers.columnRenderers,
// //         lookupNavigation,
// //         renderLookupLink,
// //         showDetailView,
// //         moduleName,
...
// //         [getEnhancedColumns]
// //     );
// //     const finalDetailConfig = useMemo(
// //         () => getAutoDetailConfig(),
// //         [getAutoDetailConfig]
// //     );
...
// //             const uniqueOptions = [
// //                 ...new Set(selectFields.map((field) => field.options)),
// //             ];
...
// //             console.log("relatedApis", relatedApis)
...
// //                 } else {
// //                     console.warn(
// //                         `Invalid options type for field ${field.name}:`,
...
// //                 console.log("...fields, options", ...field, optionsArray)
...
// //             const api = new DataApi(apiEndpoint);
// //             let response;
// //             const hasFileUpload = formFields.some(
// //                 (field) => field && field.type === "file"
// //             );
...
// //                 PubSub.publish("RECORD_SAVED_TOAST", {
// //                     title: "Success",
// //                     message: `${moduleLabel} ${editingItem ? "updated" : "created"
// //                         } successfully`,
// //                 });
// //                 fetchData();
// //                 setShowModal(false);
...
// //                     errorCount++;
// //                     errors.push(
// //                         `Row ${multiInsertRows.indexOf(row) + 1}: ${error.message}`
// //                     );
// //                 }
// //             }
...
// //                                             (col) => col && visibleColumns[col.field]
// //                                         )}
// //                                         loading={loading}
...
// //                                         }
// //                                         emptyMessage={
// //                                             emptyMessage || `No ${moduleLabel.toLowerCase()} found`
// //                                         }
// //                                     />
// //                                 </>
// //                             )}
...
// //                 </Modal.Header>
// //                 <Modal.Body>
// //                     Are you sure you want to delete this {moduleLabel.toLowerCase()}? This
...
// //                     onHide={() => setShowBulkInsertModal(false)}
// //                     size="xl"
// //                     centered
// //                     scrollable
// //                 >
...
// //                             Add multiple {moduleLabel.toLowerCase()} records at once. Leave
// //                             cells empty to skip.
// //                         </p>
...
// //                                 {multiInsertRows.filter((row) => !hasRowData(row)).length} empty
// //                                 row(s)
// //                             </small>
// //                         </div>
// //                     </Modal.Body>
...
// //                         <Button
// //                             variant="outline-secondary"
// //                             onClick={() => setShowBulkInsertModal(false)}
// //                         >
// //                             Cancel
// //                         </Button>
// //                         <Button
...
// //                             disabled={
// //                                 loading || multiInsertRows.filter(hasRowData).length === 0
// //                             }
// //                         >
// //                             {loading ? (
// //                                 <>
...
//         PubSub.publish("RECORD_SAVED_TOAST", {
//           title: "Bulk Insert Complete",
//           message: `Successfully inserted ${successCount} ${moduleLabel.toLowerCase()}(s)${
