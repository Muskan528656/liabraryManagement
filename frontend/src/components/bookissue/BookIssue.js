...
const BookIssue = () => {
  ...
  // State for books and library cards
      ...
      <Tab.Container activeKey={activeTab} onSelect={(k) => setActiveTab(k || "issue")}>
        <Nav variant="tabs" className="mb-4" style={{ borderBottom: "2px solid #e5e7eb" }}>
          <Nav.Item>
            ...
            >
              <i className="fa-solid fa-hand-holding me-2" style={{ color: activeTab === "issue" ? "#000000" : "#6b7280" }}></i>
              <span style={{ color: activeTab === "issue" ? "#000000" : "#6b7280" }}>Issue New Book</span>
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link
            ...
            >
              <i className="fa-solid fa-list me-2" style={{ color: activeTab === "list" ? "#000000" : "#6b7280" }}></i>
              <span style={{ color: activeTab === "list" ? "#000000" : "#6b7280" }}>View Issued Books ({issuedBooks.length})</span>
            </Nav.Link>
          </Nav.Item>
        </Nav>
                ...
                <Card className="mb-4 shadow-sm" style={{ background: "#f3e8ff", border: "1px solid #d8b4fe" }}>
                  ...
                  <Col md={4}>
                    <Form.Select
                      ...
                      onChange={(e) => setBookSearchField(e.target.value)}
                      style={{ border: "2px solid #8b5cf6", borderRadius: "8px", padding: "8px" }}
                    >
                  ...
                  <Col md={8}>
                    <InputGroup>
                      <Form.Control
                        ...
                        type="text"
                        placeholder="Type or scan ISBN, title, or author..."
                      ...
                      <Button
                        ...
                        disabled={!bookSearchInput.trim() || searchingBooks}
                        style={{
                  ...
                  <Col md={6}>
                    <div className="d-flex justify-content-end align-items-center gap-3">
                      <InputGroup style={{ maxWidth: "400px" }}>
                        <InputGroup.Text style={{ background: "#e9d5ff", borderColor: "#8b5cf6" }}>
                          <i className="fa-solid fa-search" style={{ color: "#6f42c1" }}></i>
                        </InputGroup.Text>
                        <Form.Control
                          type="text"
                          placeholder="Search by book title, ISBN, member name, or card number..."
                          value={searchTerm}
                          onChange={(e) => {
