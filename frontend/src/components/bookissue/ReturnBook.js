                ...
                <Tab.Container activeKey={activeTab} onSelect={(k) => setActiveTab(k || "submit")}>
                    <Nav variant="tabs" className="mb-4" style={{ borderBottom: "2px solid #e5e7eb" }}>
                        <Nav.Item>
                            ...
                            >
                                <i className="fa-solid fa-book-return me-2" style={{ color: activeTab === "submit" ? "#000000" : "#6b7280" }}></i>
                                <span style={{ color: activeTab === "submit" ? "#000000" : "#6b7280" }}>Submit Book</span>
                            </Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link
                            ...
                            >
                                <i className="fa-solid fa-list me-2" style={{ color: activeTab === "submitted" ? "#000000" : "#6b7280" }}></i>
                                <span style={{ color: activeTab === "submitted" ? "#000000" : "#6b7280" }}>View Submitted Books ({submittedBooks.length})</span>
                            </Nav.Link>
                        </Nav.Item>
                    </Nav>
