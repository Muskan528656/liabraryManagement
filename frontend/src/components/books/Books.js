...
// // import { Container, Row, Col, Card, Button, Form, Modal, InputGroup, Badge, Dropdown, Table } from "react-bootstrap";
...
// //   // Clear selection when searchTerm changes
// //   useEffect(() => {
// //     setSelectedItems([]);
// //   }, [searchTerm]);
...
// //   // Listen for PubSub event to open add book modal
// //   useEffect(() => {
...
// //       // If author API doesn't exist yet, set empty array
// //       setAuthors([]);
// //     }
// //   };
...
// //       // If category API doesn't exist yet, set empty array
// //       setCategories([]);
// //     }
// //   };
...
// //     // Convert multiInsertRows to bulkInsertData format
...
// //           {/* {!rolePermissions["books"]?.can_read ? (
...
// //                   You don't have permission to view books. Please contact your administrator to request access.
// //                 </p>
// //               </Card.Body>
// //             </Card>
// //           ) : ( */}
...
//   // New handler functions for dropdown actions
...
//   // Updated actionsRenderer with three-dot dropdown
//   const actionsRenderer = (book) => {
//     return (
//       <div className="d-flex gap-2">
//         <Dropdown>
...
//               <p><strong>Category:</strong> {selectedBook.category_name}</p>
...
//       {/* Issue Details Modal */}
//       <Modal show={showIssueModal} onHide={() => setShowIssueModal(false)} size="lg" centered>
//         <Modal.Header closeButton>
//           <Modal.Title>Issue History: {selectedBook?.title}</Modal.Title>
//         </Modal.Header>
//         <Modal.Body>
//           {selectedBook && (
//             <div>
//               <p>Showing issue history for: <strong>{selectedBook.title}</strong></p>
...
//                     <td>2024-01-15</td>
//                     <td>2024-02-15</td>
//                     <td><Badge bg="success">Returned</Badge></td>
//                   </tr>
//                   <tr>
//                     <td>Jane Smith</td>
//                     <td>2024-03-01</td>
//                     <td>-</td>
//                     <td><Badge bg="warning">Issued</Badge></td>
//                   </tr>
//                 </tbody>
//               </Table>
//             </div>
...
const Books = () => {
  ...
  // New handler functions for dropdown actions - Open in new tabs
  const handleView = (book) => {
    // Open book detail page in new tab
  ...
  const handleIssueDetails = (book) => {
    // Open issue details page in new tab
    const newTab = window.open(`/books/${book.id}/issues`, '_blank');
    if (newTab) {
      newTab.focus();
    }
  };
