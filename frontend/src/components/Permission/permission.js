...
//                     <h6 className="mb-0 fw-bold">{role.role_name}</h6>
...
//                                 <i
//                                     className="fa-solid fa-edit me-2 text-primary cursor-pointer"
//                                     onClick={() => handleInlineEditStart(role.role_id, role.role_name)}
//                                     title="Edit"
//                                 ></i>

//                                 <i
//                                     className="fa-solid fa-trash me-1 text-danger cursor-pointer"
//                                     onClick={() => handleDeleteRole(role.role_id, role.role_name)}
//                                     title="Delete"
//                                 ></i>
//                             </>
...
//                                 <thead className="table-light">
//                                     <tr>
//                                         <th width="30%" className="ps-4">Module</th>
//                                         <SelectAllHeader permissionType="allow_view" label="View" />
//                                         <SelectAllHeader permissionType="allow_create" label="Create" />
//                                         <SelectAllHeader permissionType="allow_edit" label="Edit" />
//                                         <SelectAllHeader permissionType="allow_delete" label="Delete" />
...
//                                     {role.permissions.map(perm => (
//                                         <tr key={`${role.role_id}-${perm.module_id}`}>
//                                             <td className="ps-4">{perm.module_name}</td>
//                                             <td className="text-center">
//                                                 <PermissionCell isEditing={isEditing} moduleId={perm.module_id} field="allow_view" value={perm.allow_view} onToggle={handleInlineToggle} />
//                                             </td>
//                                             <td className="text-center">
//                                                 <PermissionCell isEditing={isEditing} moduleId={perm.module_id} field="allow_create" value={perm.allow_create} onToggle={handleInlineToggle} />
//                                             </td>
//                                             <td className="text-center">
//                                                 <PermissionCell isEditing={isEditing} moduleId={perm.module_id} field="allow_edit" value={perm.allow_edit} onToggle={handleInlineToggle} />
//                                             </td>
//                                             <td className="text-center">
//                                                 <PermissionCell isEditing={isEditing} moduleId={perm.module_id} field="allow_delete" value={perm.allow_delete} onToggle={handleInlineToggle} />
//                                             </td>
//                                         </tr>
//                                     ))}
//                                 </tbody>
